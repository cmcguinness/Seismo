...
def _build_spark_svg(tr):
    ...
    return (
        ...
        f'class="spark-base" stroke-width="1"/>'
        ...
        f'<line x1="{x_on:.0f}" y1="0" x2="{x_on:.0f}" y2="{SPARK_H}" class="spark-onset" '
        f'stroke-width="1.8" stroke-dasharray="3 2" opacity="0.95"/>'
        f'<polygon points="{top} {bot}" class="spark-fill" fill-opacity="0.85"/>'
        f'</svg>'
    )
