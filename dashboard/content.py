...
HELI_HOWTO = (
    ...
    'drum&nbsp;&rarr;</a></p>'
    '<details class="mt-3"><summary class="btn btn-outline-primary btn-lg w-100 text-start" '
    'style="cursor:pointer;list-style:none;display:flex;align-items:center;gap:.75em">'
    '<span style="font-size:1.4em">&#x1F449;</span><span><b>Click here to see what a REAL earthquake '
    'looks like on this drum</b><br><span class="small fw-normal">the M4.2 Cloverdale quake of '
    '29 July 2026, 45&nbsp;km away &mdash; nothing like the little bursts above</span></span></summary>'
