...
HELI_HOWTO = (
    ...
    'door, a car. What marks them is not the presence of high frequencies but the '
    '<i>balance</i>: a burst is faded when it carries more energy above about 15&nbsp;Hz than '
    'it does in the 1&ndash;8&nbsp;Hz band where earthquakes put most of theirs. Distance does '
    'strip the high frequencies out of an earthquake, but over tens of kilometres, not metres '
    '&mdash; the M3.3 under Larkfield-Wikiup was still 16&times; above the noise floor at '
    '35&ndash;50&nbsp;Hz from 13&nbsp;km away, and people heard it as a sound. It is not faded '
    'here because that energy, real as it was, is a small fraction of what arrived lower down. '
    'The solid core drawn inside a faded burst is the 1&ndash;8&nbsp;Hz part, the band a quake '
    'would occupy.</p>'
    ...
    'drum&nbsp;&rarr;</a></p>'
    '<details class="mt-2"><summary style="cursor:pointer">'
    '<b style="color:var(--copper);text-decoration:underline">See what a real earthquake '
    'looks like on this drum&nbsp;&rarr;</b> the M4.2 Cloverdale quake of 29 July 2026, '
    '45&nbsp;km away</summary>'
    '<img src="/catches/drum-2026-07-29-cloverdale-m4.2.png" class="plot mt-2" style="width:50%;margin:0 auto" loading="lazy" '
    'alt="Helicorder drum showing the M4.2 Cloverdale earthquake of 2026-07-29 at 02:40 UTC">'
    '<div class="text-muted small text-center">a saved image of that night&rsquo;s drum, shown at half size &mdash; not live</div>'
...
LEARN_SECTIONS = [
    ...
    ("What this geophone can and cannot hear",
     ...
     '<td class="text-yes"><b>Loud and clear</b> &mdash; most of what we record</td></tr>'
     '<tr><td>Small local earthquake, tens of km</td><td>2&ndash;20 Hz</td>'
     '<td class="text-yes"><b>Yes</b> &mdash; the target</td></tr>'
     ...
     '<td class="text-no"><b>No</b> &mdash; arrives as slow swells we are deaf to</td></tr>'
     '<tr><td>Ocean microseism</td><td>0.07&ndash;0.15 Hz</td>'
     '<td class="text-no"><b>No</b> &mdash; ~1000× below our response</td></tr>'
     '<tr><td>Earth&rsquo;s &ldquo;hum&rdquo; (free oscillations)</td><td>0.002&ndash;0.007 Hz</td>'
     '<td class="text-no"><b>No</b> &mdash; needs a million-dollar gravimeter</td></tr>'
     '</tbody></table></div>'
    ...
    ("How to read the helicorder",
     ...
     '<img src="/catches/drum-2026-07-29-cloverdale-m4.2.png" class="plot" style="width:50%;margin:0 auto" loading="lazy" '
     'alt="Helicorder drum showing the M4.2 Cloverdale earthquake of 2026-07-29 at 02:40 UTC">'
     '<div class="text-muted small text-center">a saved image of that night&rsquo;s drum, shown at half size &mdash; not live</div>'
    ...
    ("Keep learning",
     ...
     '<p class="prose"><b>The home fault first.</b> The Rodgers Creek fault runs under Santa Rosa a few '
     'kilometres from this station, and it is the one the professionals name most often when '
     'asked where the Bay Area&rsquo;s next big one comes from:</p>'
     '<ul class="prose">'
     '<li><a target="_blank" rel="noopener" href="https://www.usgs.gov/news/rodgers-creek-fault-traced-through-santa-rosa">'
     'Rodgers Creek Fault traced through Santa Rosa</a> (USGS, 2016) &mdash; how lidar and '
     'magnetic surveys found the fault&rsquo;s trace under the city, where a century of building '
     'had hidden it.</li>'
     '<li><a target="_blank" rel="noopener" href="https://www.usgs.gov/programs/earthquake-hazards/science/a-new-map-rodgers-creek-fault-sonoma-county-california">'
     'A new map of the Rodgers Creek fault</a> (USGS) &mdash; the current map of the active '
     'traces, which turn out to reach 17&nbsp;km further north than anyone had drawn them.</li>'
     '<li><a target="_blank" rel="noopener" href="https://www.usgs.gov/media/images/hayward-rodgers-creek-fault-zone-san-francisco-bay-area">'
     'The Hayward&ndash;Rodgers Creek connection</a> (USGS) &mdash; the 2016 finding that the two '
     'faults join under San Pablo Bay, so they can rupture together: a 190&nbsp;km fault, not two '
     'shorter ones. That is why the 33&nbsp;% figure for an M6.7+ by 2043 is quoted for the pair.</li>'
     '</ul>'
     '<p class="prose">Then the general reading:</p>'
     '<ul class="prose mb-0">'
     '<li><a target="_blank" rel="noopener" href="https://www.usgs.gov/programs/earthquake-hazards/science-earthquakes">'
     ...
     '<li><a target="_blank" rel="noopener" href="https://www.usgs.gov/programs/earthquake-hazards/earthquake-magnitude-energy-release-and-shaking-intensity">'
     ...
     'where you were.</li>'
     '<li><a target="_blank" rel="noopener" href="https://www.iris.edu/hq/inclass">IRIS / EarthScope classroom animations</a> '
     ...
     '<li><a target="_blank" rel="noopener" href="https://seismo.berkeley.edu/">Berkeley Seismology Lab</a> &mdash; the '
     ...
     '<li><a target="_blank" rel="noopener" href="https://pubs.usgs.gov/fs/2008/3019/">The Hayward Fault &mdash; is it due '
     ...
     '<li><a target="_blank" rel="noopener" href="https://earthquake.usgs.gov/earthquakes/map/">USGS Latest Earthquakes</a> '
     '&mdash; the live map; every catch on this site was confirmed against it.</li>'
     '<li><a target="_blank" rel="noopener" href="https://www.earthquakecountry.org/roots/">Putting Down Roots in Earthquake '
     ...
     '<li><a target="_blank" rel="noopener" href="https://www.shakealert.org/">ShakeAlert</a> &mdash; earthquake early warning '
