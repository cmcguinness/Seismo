# STATUS — ARCHIVE (2026-07-17 → 2026-08-15)

Older entries moved out of `STATUS.md` on 2026-08-26 so the live file stays readable.
Nothing here was edited; newest first, as it was. The current system summary and the
recent entries live in [`STATUS.md`](STATUS.md). Search this file for the full story
behind any line in the archive index there.
